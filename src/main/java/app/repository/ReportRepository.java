...
public class ReportRepository implements CrudRepository<BorrowReport, Integer> {
     ...
     *
     * @param entity Object want to save to database (mapping to {@code T} type
     *               table)
     */
    @Override
     ...
     * @return List of all {@link BorrowReport} which is exists with the condition
     *         in DB
     */
     ...
     * @return {@code boolean true/false} indicating whether the update was
     *         successful
     */
